...
function groups.get(contrast)
  ...
  return {
    ...
    NeoTreeDirectoryName = { link = "Green" },
    NeoTreeFileName = { link = "Fg" },
    NeoTreeFileIcon = { link = "Fg" },
    NeoTreeFileNameOpened = { link = "Fg" },
    NeoTreeIndentMarker = { link = "Grey" },
    NeoTreeRootName = { link = "Grey" },
    NeoTreeSymbolicLinkTarget = { link = "Green" },
    NeoTreeGitAdded = { link = "Aqua" },
    NeoTreeGitConflict = { link = "Orange" },
    NeoTreeGitDeleted = { link = "Red" },
    NeoTreeGitIgnored = { link = "Grey" },
    NeoTreeGitModified = { link = "Yellow" },
    NeoTreeGitUnstaged = { link = "Yellow" },
    NeoTreeGitUntracked = { link = "Aqua" },
    NeoTreeGitStaged = { link = "Blue" },
    NeoTreeFloatBorder = { link = "Grey" },
    NeoTreeFloatTitle = { link = "Orange" },
    NeoTreeTitleBar = { link = "Orange" },
    NeoTreeWindowsHidden = { link = "Grey" },

    -- stevearc/oil.nvim
    OilDir = { link = "Green" },
    OilDirIcon = { link = "Orange" },
    OilFile = { link = "Fg" },
    OilFileIcon = { link = "Fg" },
    OilLink = { link = "Aqua" },
    OilLinkTarget = { link = "Green" },
    OilCopy = { link = "Yellow" },
    OilMove = { link = "Blue" },
    OilChange = { link = "Yellow" },
    OilCreate = { link = "Aqua" },
    OilDelete = { link = "Red" },
    OilPermissionNone = { link = "Grey" },
    OilPermissionRead = { link = "Yellow" },
    OilPermissionWrite = { link = "Orange" },
    OilPermissionExecute = { link = "Green" },
    OilTypeDir = { link = "Green" },
    OilTypeFile = { link = "Fg" },
    OilTypeLink = { link = "Aqua" },
    OilTypeSocket = { link = "Purple" },
    OilTypeFifo = { link = "Purple" },
